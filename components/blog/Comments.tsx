    ...
    <div className="p-4 bg-white border border-ink-100 hover:border-ink-200 transition-colors">
      <div className="flex gap-3">
        {comment.user.image ? (
          ...
          <div className="w-10 h-10 rounded-full flex-shrink-0 bg-ink-200 flex items-center justify-center text-ink-700 font-semibold" style={{ fontFamily: "'Playfair Display', serif" }}>
    ...
    <div className="mt-12">
      ...
      {status === 'authenticated' ? (
        ...
        <div className="mb-8 p-6 bg-ink-50 border-2 border-ink-200 text-center">
          <p className="text-ink-600 mb-3" style={{ fontFamily: 'Lora, serif' }}>
            Sign in to join the conversation
          </p>
          <button
            onClick={() => router.push('/auth/signin')}
            className="px-6 py-2 bg-ink-950 text-white hover:bg-ink-900 transition-colors"
            style={{ fontFamily: 'Lora, serif' }}
          >
            Sign In
          </button>
